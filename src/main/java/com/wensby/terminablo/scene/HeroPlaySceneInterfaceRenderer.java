...
public class HeroPlaySceneInterfaceRenderer {
    ...
    public HeroPlaySceneInterfaceRenderer(OrbTerminalRepresentationFactory orbTerminalRepresentationFactory, TerminalLayerFactory terminalLayerFactory, final TerminalCharacterFactory terminalCharacterFactory) {
