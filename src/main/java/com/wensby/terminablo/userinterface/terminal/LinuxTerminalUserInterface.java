...
import com.wensby.terminablo.userinterface.*;
...
public class LinuxTerminalUserInterface implements UserInterface {
    ...
    public LinuxTerminalUserInterface(LinuxTerminal linuxTerminal, LinuxTerminalKeyboard keyboard, LinuxTerminalVisualCanvas canvas) {
