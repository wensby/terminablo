...
public class BorderDecorator extends ComponentDecorator {
  ...
  private void renderHorizontalLine(char[][] canvas, int row, int columnStart, int columnEnd,
      char character) {
  ...
  private void renderVerticalLine(char[][] canvas, final int column, final int rowStart,
      final int rowEnd, char character) {
