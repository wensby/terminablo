...
public class OrbTerminalRepresentationFactoryTest {
    ...
    public void createRepresentation_when1By1Size_andFullHealth() {
        ...
        OrbTerminalRepresentationFactory factory = new OrbTerminalRepresentationFactory(characterFactory);
        ...
        LinuxDecorativeCharacter character = (LinuxDecorativeCharacter) representation.getCharacters()[0][0];
